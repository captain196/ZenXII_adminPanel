<?php
/**
 * Bulk Student Import — upload step (sis/master_student).
 * Redesigned to match the staff importer: guided 3-step flow, drag-&-drop
 * dropzone, scannable guidance. Posts to sis/import_preview (field: excelFile).
...
<style>
  ...
  .imx-flash { display:flex; align-items:center; gap:9px; padding:11px 14px; border-radius:10px; font-size:.92rem; margin-bottom:16px; }
  ...
  .imx-sub { color:var(--muted); font-size:.94rem; margin:2px 0 0; }
  ...
  .imx-steps li .imx-step-n { width:26px; height:26px; border-radius:50%; background:var(--surface-2); color:var(--muted); border:1px solid var(--border-2); display:flex; align-items:center; justify-content:center; font-weight:800; font-size:.85rem; margin-bottom:6px; }
  ...
  .imx-step-t { font-weight:700; font-size:.92rem; }
  .imx-step-d { color:var(--faint); font-size:.78rem; }
  ...
  .imx-drop-main { font-weight:700; font-size:1.04rem; }
  .imx-drop-or { color:var(--muted); font-size:.9rem; margin-top:2px; }
  .imx-link { color:var(--brand); font-weight:700; text-decoration:underline; }
  .imx-drop-hint { color:var(--faint); font-size:.8rem; margin-top:8px; }
  ...
  .imx-file-size { color:var(--faint); font-size:.8rem; }
  ...
  .imx-err { color:var(--danger); font-size:.84rem; margin-top:10px; }
  .imx-actions { display:flex; gap:10px; margin-top:16px; }

  .imx-btn { display:inline-flex; align-items:center; gap:7px; border:1px solid transparent; border-radius:10px; padding:10px 16px; font-size:.92rem; font-weight:700; cursor:pointer; text-decoration:none; }
  ...
  .imx-btn-tpl { background:var(--brand-soft); color:var(--brand-d); border-color:var(--brand-bd); font-size:.87rem; padding:8px 14px; }
  ...
  .imx-tpl-text { color:var(--muted); font-size:.85rem; margin:3px 0 10px; line-height:1.45; }

  .imx-tips { padding:16px; }
  .imx-tips-h { font-weight:800; font-size:.8rem; letter-spacing:.5px; text-transform:uppercase; color:var(--faint); margin-bottom:10px; }
  .imx-tiplist { list-style:none; padding:0; margin:0; display:flex; flex-direction:column; gap:10px; }
  .imx-tiplist li { display:flex; gap:10px; font-size:.87rem; color:var(--ink-2); line-height:1.4; }
