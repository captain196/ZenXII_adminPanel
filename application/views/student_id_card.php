...
(function () {
  ...
  function getCardCSS(forPrint) {
    return [
      ...
      /* Photo ring */
      '.ic-photo-ring{width:74px;height:74px;border-radius:50%;border:3px solid #BC5A3C;box-shadow:0 2px 12px rgba(188,90,60,.3);margin-top:12px;overflow:hidden;display:flex;align-items:center;justify-content:center;background:#F7ECE7;flex-shrink:0;}',
      ...
      '.ic-badge-cls{background:#F7ECE7;color:#BC5A3C;}',
      '.ic-badge-sec{background:#d1fae5;color:#065f46;}',
      '.ic-badge-gen{background:#e0f2fe;color:#0369a1;}',
      /* Divider */
      '.ic-divider{width:85%;height:1px;background:linear-gradient(90deg,transparent,#BC5A3C55,transparent);margin:2px 0 6px;}',
      /* Info rows */
      ...
      '.ic-info-ico{color:#BC5A3C;font-size:.7rem;width:14px;text-align:center;flex-shrink:0;}',
