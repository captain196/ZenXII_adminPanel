...
const STARTERS = [
  {id:"lc_5a", docType:"leaving_certificate_5a", name:"Leaving Certificate — Form 5A",
   meta:"Kerala · r.17(3) · field list not retrieved", states:["Kerala"], build:starterForm5A},
  {id:"tc_cbse",   docType:"transfer_certificate", name:"Annexure-I form",
   meta:"CBSE · 22 fields · Level A", boards:["CBSE"], build:starterTC},
  {id:"tc_plain",  docType:"transfer_certificate", name:"Plain letterhead",
   meta:"any board · prose form", boards:null, build:starterTCplain},
  {id:"sec_ker",   docType:"school_education_certificate", name:"Certificate of School Education",
   meta:"Kerala · r.22A · field list Level A", states:["Kerala"], build:starterKeralaSEC},
  {id:"bonafide",  docType:"bonafide", name:"Classic bonafide",
   meta:"no statutory basis found · free format", boards:null, build:starterBonafide},
  {id:"conduct",   docType:"character", name:"Conduct and character",
   meta:"TNER r.34 / App. 5-B shape", boards:null, build:starterConduct}
];
...
function paintGallery(){
  ...
  blank.innerHTML=`<div class="tpl-card__thumb">＋</div><div class="tpl-card__body">
    ...
    <div class="tpl-card__meta">A4 portrait · required objects pre-placed</div></div>`;
  blank.onclick=()=>{
...
function paintInspector(){
  ...
  B.innerHTML = alignRow() + `
    ...
    ${o.type==="text"?`<div class="row row--1" style="margin-top:10px">
      <button class="btn btn--sm" data-act="edit">✎ Edit text <span class="btn__hint">Enter</span></button></div>`:""}
...
function render(){
  ...
  paintLayers(); paintFieldList(); paintBlocks(); paintInspector(); paintPagePanel();
